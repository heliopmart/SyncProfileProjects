...
const HomePage: React.FC = () => {
  ...
  return (
    <div className="homePage">
        <HeaderIndex languageSelect={getLanguage} optionSelect={getSiteExperience}/>
        <SectionHeaderImage/>
        ...
        <Footer language={language == 'br' ? LanguagesFooter_br as InterfaceFooter : LanguagesFooter__us as InterfaceFooter} key={'footer'+language} />
    </div>
  );
};
